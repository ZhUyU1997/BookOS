...
#define	LAYER_INVISIBLE  0xabcdef			//图层为窗口
#define	LAYER_NOINVISIBLE  0xffffff			//图层为窗口
...
void layer_init2(struct layer *layer, uint8_t *buf, int wide, int high, int32_t color_invisible);
